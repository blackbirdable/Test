...
weights_file_path = r"C:\Users\Administrator\Desktop\Sonixen\Strategies\Maker\Final Weights\INPUT WEIGHTS.csv"
equal_weights_file_path = r"C:\Users\Administrator\Desktop\Sonixen\Strategies\Maker\Final Weights\EQUAL WEIGHTS.csv"
mm_weights_file_path = r"C:\Users\Administrator\Desktop\Sonixen\Strategies\Maker\Final Weights\MM_WEIGHTS.csv"
btc_weights_file_path = r"C:\Users\Administrator\Desktop\Sonixen\Strategies\Maker\Final Weights\BTC INPUT WEIGHTS.csv"
output_pnl_log_path = r"C:\Users\Administrator\Desktop\EMS_BTD_AC1_Portfolio.py"
db_path = r"C:\Users\Administrator\Desktop\TradingData_BTD_AC2.db"
...
def create_table(df, title, share_prices=None):
    ...
    if title == "Positions" and not df.empty and 'OpenPNL' in df.columns:
        ...
        share_price_weighted = (total_weighted + 5000) / 100
